# CONTENT using Next JS 14+, Tailwind CSS 3.4 and TypeScript
...
```shell
git clone --depth=1 https://github.com/VikaVP/content my-project-name
cd my-project-name
npm install
```
